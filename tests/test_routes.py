...
class TestProductRoutes(TestCase):
    ...
    def test_get_product_not_found(self):
        """It should handle Get a product with invalid ID"""
    ...
    def test_update_non_existing_product(self):
        """It shoud fail to update non-existing Product"""
    ...
    def test_get_product_list(self):
        """It shoud get a list of Products"""
    ...
    def test_query_by_name(self):
        ...
        test_count = len([product for product in products if product.name == test_name])
    ...
    def test_query_by_category(self):
        """It shoud Query Products by Category"""
